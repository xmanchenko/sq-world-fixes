...
function explode(keys, delay)
	...
	local particle = "particles/econ/items/abaddon/abaddon_alliance/abaddon_aphotic_shield_alliance_explosion.vpcf"--"particles/econ/items/crystal_maiden/crystal_maiden_cowl_of_ice/maiden_crystal_nova_cowlofice.vpcf"
	local particle_pre = "particles/units/heroes/hero_abaddon/abaddon_aphotic_shield.vpcf"--"particles/units/heroes/hero_ancient_apparition/ancient_ice_vortex.vpcf"
	...
	EmitSoundOn("Hero_Abaddon.AphoticShield.Cast", pre_dummy)
	...
	Timers:CreateTimer(delay, function()
			...
			EmitSoundOn("Hero_Abaddon.AphoticShield.Destroy", dummy)
