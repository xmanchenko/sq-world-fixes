...
LinkLuaModifier( "modifier_spawn_creeps", "items/box/box_1", LUA_MODIFIER_MOTION_NONE )
...
item_box_1 = class({})
--------------------------------------------------------------------------------
function item_box_1:OnSpellStart(cheat_target)
	...
	for i=0,5 do
		...
		local unit = CreateUnitByName("npc_box_1", vTargetPosition, true, nil, nil, DOTA_TEAM_GOODGUYS)
...
function spawn(keys)
	...
	unit:SetUnitName("creep_box_1")
	unit:SetBaseDamageMin(25)
	unit:SetBaseDamageMax(25)
