modifier_yellow_exclamation_mark = class({})

function modifier_yellow_exclamation_mark:IsHidden()
	return true
end

function modifier_yellow_exclamation_mark:IsPurgable()
	return false
end

function modifier_yellow_exclamation_mark:IsPermanent()
	return true
end

function modifier_yellow_exclamation_mark:OnCreated( kv )
...
function modifier_yellow_exclamation_mark:OnDestroy( kv )
