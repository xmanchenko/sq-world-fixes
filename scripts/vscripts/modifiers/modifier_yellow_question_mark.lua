modifier_yellow_question_mark = class({})

function modifier_yellow_question_mark:IsHidden()
	return true
end

function modifier_yellow_question_mark:IsPurgable()
	return false
end

function modifier_yellow_question_mark:IsPermanent()
	return true
end

function modifier_yellow_question_mark:OnCreated( kv )
...
function modifier_yellow_question_mark:OnDestroy( kv )
