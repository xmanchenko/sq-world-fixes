...
LinkLuaModifier( "modifier_skywrath_mage_concussive_shot_lua", "heroes/hero_skywrath_mage/skywrath_mage_concussive_shot_lua/modifier_skywrath_mage_concussive_shot_lua", LUA_MODIFIER_MOTION_NONE )
...
--------------------------------------------------------------------------------
-- Projectile
function skywrath_mage_concussive_shot_lua:OnProjectileHit( target, location, damage )
	...
	local abil = self:GetCaster():FindAbilityByName("npc_dota_hero_skywrath_mage_int8")	
	if abil ~= nil then 
