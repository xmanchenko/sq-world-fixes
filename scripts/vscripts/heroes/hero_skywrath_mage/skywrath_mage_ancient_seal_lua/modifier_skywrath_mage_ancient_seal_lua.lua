...
function modifier_skywrath_mage_ancient_seal_lua:GetModifierPhysicalArmorBonus()
	local abil = self:GetCaster():FindAbilityByName("npc_dota_hero_skywrath_mage_str10")	
	if abil ~= nil then 
	return self:GetParent():GetPhysicalArmorBaseValue() * self.magic_resist / 100
	else
	return 0
	end
end
