npc_dota_hero_weaver_str10 = class({})

function npc_dota_hero_weaver_str10:GetIntrinsicModifierName()
	return "modifier_phantom_assassin_lifesteal"
end

LinkLuaModifier( "modifier_phantom_assassin_lifesteal", "heroes/hero_weaver/lifesteal", LUA_MODIFIER_MOTION_NONE )
