LinkLuaModifier( "modifier_armor_debuff", "heroes/hero_phantom/armor_debuff", LUA_MODIFIER_MOTION_NONE )	
LinkLuaModifier( "modifier_armor_debuff_debuff", "heroes/hero_phantom/armor_debuff", LUA_MODIFIER_MOTION_NONE )	


npc_dota_hero_phantom_assassin_agi7 = class({})

function npc_dota_hero_phantom_assassin_agi7:GetIntrinsicModifierName()
	return "modifier_armor_debuff"
end
