LinkLuaModifier( "modifier_armor_debuff", "heroes/hero_slark/armor_debuff", LUA_MODIFIER_MOTION_NONE )	
LinkLuaModifier( "modifier_armor_debuff_debuff", "heroes/hero_slark/armor_debuff", LUA_MODIFIER_MOTION_NONE )	


npc_dota_hero_slark_agi8 = class({})

function npc_dota_hero_slark_agi8:GetIntrinsicModifierName()
