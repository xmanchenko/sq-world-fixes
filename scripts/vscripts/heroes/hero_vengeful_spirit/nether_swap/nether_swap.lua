if vengeful_spirit_nether_swap == nil then
    vengeful_spirit_nether_swap = class({})
end

--------------------------------------------------------------------------------

function vengeful_spirit_nether_swap:CastFilterResultTarget( target )
...
function vengeful_spirit_nether_swap:OnSpellStart()
