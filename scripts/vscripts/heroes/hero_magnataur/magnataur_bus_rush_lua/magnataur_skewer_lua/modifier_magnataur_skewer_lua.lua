...
--------------------------------------------------------------------------------
modifier_magnataur_skewer_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_magnataur_skewer_lua:IsHidden()
	return false
end

function modifier_magnataur_skewer_lua:IsDebuff()
	return false
end

function modifier_magnataur_skewer_lua:IsStunDebuff()
	return false
end

function modifier_magnataur_skewer_lua:IsPurgable()
	return false
end
...
function modifier_magnataur_skewer_lua:OnRefresh( kv )
	self:OnCreated( kv )
end

function modifier_magnataur_skewer_lua:OnRemoved()
end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_magnataur_skewer_lua:DeclareFunctions()
	local funcs = {
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_magnataur_skewer_lua:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion Effects
function modifier_magnataur_skewer_lua:UpdateHorizontalMotion( me, dt )
...
function modifier_magnataur_skewer_lua:OnHorizontalMotionInterrupted()
	self:Destroy()
end

--------------------------------------------------------------------------------
-- Aura Effects
function modifier_magnataur_skewer_lua:IsAura()
	return true
end

function modifier_magnataur_skewer_lua:GetModifierAura()
	return "modifier_magnataur_skewer_lua_debuff"
end

function modifier_magnataur_skewer_lua:GetAuraRadius()
	return self.radius
end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_magnataur_skewer_lua:PlayEffects()
	-- Get Resources
