npc_dota_hero_terrorblade_agi10 = class({})
LinkLuaModifier( "modifier_npc_dota_hero_terrorblade_agi10", "heroes/hero_terror/split", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function npc_dota_hero_terrorblade_agi10:GetIntrinsicModifierName()
	return "modifier_npc_dota_hero_terrorblade_agi10"
end

--------------------------------------------------------------------------------

modifier_npc_dota_hero_terrorblade_agi10 = class({})

function modifier_npc_dota_hero_terrorblade_agi10:IsHidden()
end

function modifier_npc_dota_hero_terrorblade_agi10:IsDebuff( kv )
	return false
end

function modifier_npc_dota_hero_terrorblade_agi10:IsPurgable( kv )
	return false
end


function modifier_npc_dota_hero_terrorblade_agi10:DeclareFunctions()
	local funcs = {
...
function modifier_npc_dota_hero_terrorblade_agi10:OnAttack(keys)
