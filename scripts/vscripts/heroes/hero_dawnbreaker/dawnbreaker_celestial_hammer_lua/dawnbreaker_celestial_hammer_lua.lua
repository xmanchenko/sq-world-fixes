...
LinkLuaModifier( "modifier_dawnbreaker_celestial_hammer_lua", "heroes/hero_dawnbreaker/dawnbreaker_celestial_hammer_lua/modifier_dawnbreaker_celestial_hammer_lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_dawnbreaker_celestial_hammer_lua_nohammer", "heroes/hero_dawnbreaker/dawnbreaker_celestial_hammer_lua/modifier_dawnbreaker_celestial_hammer_lua_nohammer", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_dawnbreaker_celestial_hammer_lua_thinker", "heroes/hero_dawnbreaker/dawnbreaker_celestial_hammer_lua/modifier_dawnbreaker_celestial_hammer_lua_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_celestial_hammer_lua_trail", "heroes/hero_dawnbreaker/dawnbreaker_celestial_hammer_lua/modifier_dawnbreaker_celestial_hammer_lua_trail", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_celestial_hammer_lua_debuff", "heroes/hero_dawnbreaker/dawnbreaker_celestial_hammer_lua/modifier_dawnbreaker_celestial_hammer_lua_debuff", LUA_MODIFIER_MOTION_NONE )
