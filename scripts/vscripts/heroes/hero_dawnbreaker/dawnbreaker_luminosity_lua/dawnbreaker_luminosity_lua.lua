...
LinkLuaModifier( "modifier_dawnbreaker_luminosity_lua", "heroes/hero_dawnbreaker/dawnbreaker_luminosity_lua/modifier_dawnbreaker_luminosity_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dawnbreaker_luminosity_lua_buff", "heroes/hero_dawnbreaker/dawnbreaker_luminosity_lua/modifier_dawnbreaker_luminosity_lua_buff", LUA_MODIFIER_MOTION_NONE )
