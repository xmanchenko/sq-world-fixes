LinkLuaModifier("modifier_npc_dota_hero_spectre_agi7", "heroes/hero_spectre/bonus_dmg", LUA_MODIFIER_MOTION_NONE)
...
function modifier_npc_dota_hero_spectre_agi7:GetModifierBaseAttack_BonusDamage(params)
...
function modifier_npc_dota_hero_spectre_agi7:OnCreated(kv)
end