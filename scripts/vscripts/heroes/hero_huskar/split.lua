npc_dota_hero_huskar_agi9 = class({})
LinkLuaModifier( "modifier_npc_dota_hero_huskar_agi9", "heroes/hero_huskar/split", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function npc_dota_hero_huskar_agi9:GetIntrinsicModifierName()
	return "modifier_npc_dota_hero_huskar_agi9"
end

--------------------------------------------------------------------------------

modifier_npc_dota_hero_huskar_agi9 = class({})

function modifier_npc_dota_hero_huskar_agi9:IsHidden()
end

function modifier_npc_dota_hero_huskar_agi9:IsDebuff( kv )
	return false
end

function modifier_npc_dota_hero_huskar_agi9:IsPurgable( kv )
	return false
end


function modifier_npc_dota_hero_huskar_agi9:DeclareFunctions()
	local funcs = {
...
--------------------------------------------------------------------------------
function modifier_npc_dota_hero_huskar_agi9:OnAttack(keys)
